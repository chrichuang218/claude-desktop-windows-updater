...
//! is unique to this project to avoid colliding with anything Anthropic ships.
//!
...
pub const UNINSTALL_SUBKEY: &str =
    r"Software\Microsoft\Windows\CurrentVersion\Uninstall\ClaudeUnofficialUpdater";
